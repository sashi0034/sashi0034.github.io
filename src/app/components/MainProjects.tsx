            ...
            <div className="flex flex-col md:flex-row gap-6">
              <div className="md:w-1/2">
                ...
                <p className="text-gray-600 mb-4">
                  <span className="font-bold">自作エンジンで開発した 99 人対戦の反重力レースゲーム</span>です。
                ...
                <ReadMoreSection collapsedHeight="3rem">
                  <p className="text-gray-600 mb-4">
                    このゲームでは、<span className="font-bold">ラスタライズ方式のディファードレンダリングにレイマーチングを組み合わせた独自のグラフィック表現</span>を採用しています。ポリゴンのレイトレーシングと異なり、SDF のレイマーチングは GPU によるハードウェアサポートが存在しないため処理負荷が高く、一般的なゲームで採用されることはほとんどありません。
                    ...
                    <br></br>
                    対戦相手となるゲーム AI に関しては、スクエア・エニックスの三宅陽一郎さんの著書などで紹介されている「<span className="font-bold">MCS-AI 動的連携モデル</span>」を参考にしました。
                  </p>
                </ReadMoreSection>
          ...
          <div className="bg-white rounded-lg shadow-lg p-6">
            <div className="flex flex-col md:flex-row gap-6">
              <div className="md:w-1/2">
                ...
                <p className="text-gray-600 mb-4">
                    かなり気合を入れて鋭意開発している 2D 探索型アクションゲームです。{/* 2026 年内に Steam で発売することを目指しています。 */}「<span className="font-bold">世界最速メトロイドヴァニア</span>」をコンセプトに、爽快でスピーディーなアクションが楽しめます。プレイ動画は一見難しそうに見えるかも知れませんが、基本的にプレイに必要なボタンは十字ボタンと A, B ボタンだけで誰でも簡単に遊ぶことができる工夫をしています。
                </p>
                <ReadMoreSection collapsedHeight="3rem">
                  <p className="text-gray-600 mb-4">
