            ...
            <div className="flex flex-col md:flex-row gap-6">
              <div className="md:w-1/2">
                ...
                <ReadMoreSection collapsedHeight="3rem">
                  <p className="text-gray-600 mb-4">
                    このゲームでは、<span className="font-bold">ラスタライズ方式のディファードレンダリングにレイマーチングを組み合わせた独自のグラフィック表現</span>を採用しています。レイトレーシングと異なり、レイマーチングは GPU によるハードウェアサポートが存在しないため処理負荷が高く、一般的なゲームで採用されることはほとんどありません。
